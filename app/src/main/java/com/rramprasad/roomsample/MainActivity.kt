...
import com.rramprasad.roomsample.data.AppDatabase
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (database != null) {
            for (allRecipe in database.recipeDao().getAllRecipes()) {
                mRecipesArrayList.add(allRecipe)
            }
    ...
    /*private fun populateData() {
        ...
        val recipes : List<Recipe> = Gson().fromJson(jsonString, Array<Recipe>::class.java).toList()
